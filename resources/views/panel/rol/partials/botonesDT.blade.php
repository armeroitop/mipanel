 ...
 <div class="input-group-prepend">
    ...
    <ul class="dropdown-menu" style="left: 0px; top: 0px; position: absolute; transform: translate3d(0px, 48px, 0px);" x-placement="bottom-start">
      ...
      <li class="dropdown-item">
        <form method="get">
          @csrf
          <a href="{{route('roles.edit', $id)}}" type="submit">Ver</a>
        </form>
      </li>     
  
      <li class="dropdown-item">
        <li  class="dropdown-item"  data-toggle="modal" data-target="#modal-editRol" onclick="editRol({{$id}},
                                                                                                        '{{$name}}',
                                                                                                        '{{$slug}}',
                                                                                                        '{{$description}}')">           
      ...
      <li  class="dropdown-item"  data-toggle="modal" data-target="#modal-eliminaRol" onclick="eliminaRol({{$id}},'{{$name}}')">           
        <a  href="#" >Eliminar</a>
      </li>
