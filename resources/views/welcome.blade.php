  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="{{ url('/') }}"><span>PlataformaCSS</span></a></h1>
            ...
            @if (Route::has('login'))                
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <li class="get-started"><a href="{{ route('register') }}">Registrate</a></li>                            
                    @endif
                @endauth                
            @endif
        </ul>
...
Los procedimientos de coordinación de seguridad y salud implantados, imponen la presencia de coordinadores especializados y con formación académica adecuada a cada tipología de obra. Así en nuestra plantilla disponemos de departamentos diferenciados para cubrir los siguientes tipos de obra            </p>
      ...
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li data-aos="fade-up" data-aos-delay="100">
            <a data-toggle="collapse" class="" href="#faq1">¿Cuándo es necesario el nombramiento de un coordinador de seguridad y salud? <i class="icofont-simple-up"></i></a>
          ...
          <li data-aos="fade-up" data-aos-delay="200">
            <a data-toggle="collapse" href="#faq2" class="collapsed">¿Puedo realizar mi obra sin contratar a un coordinador de seguridad y salud? <i class="icofont-simple-up"></i></a>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2>Equipo</h2>
          <p>Nuestro equipo siempre está aquí para ayudar.</p>
        </div>

        <div class="row">

          <div class="col-xl-3 col-lg-4 col-md-6 centre" data-aos="zoom-in" data-aos-delay="100">
            <div class="member">
              <img src="assets/img/team/DavidFotoTrabajo.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>David Martínez</h4>
                  <span>Ingeniero Técnico de Obras Públicas + Máster PRL</span>
                </div>
                <div class="social">
                 {{--  <a href=""><i class="icofont-twitter"></i></a>
                  <a href=""><i class="icofont-facebook"></i></a>
                  <a href=""><i class="icofont-instagram"></i></a> --}}
                  <a href="https://www.linkedin.com/in/armeroitop/"><i class="icofont-linkedin"></i></a>
                </div>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>PlataformaCSS</span></strong>. All Rights Reserved
      </div>
      <div class="credits">        
        Designed by <a href="#">David G. Martínez Armero</a>
      </div>
    </div>
  </footer><!-- End Footer -->
